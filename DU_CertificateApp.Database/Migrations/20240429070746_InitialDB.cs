        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamRoll = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carts_Certificates_CertificateID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_Users_AcceptedID",
                        column: x => x.AcceptedID,
                        principalTable: "Users",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_Users_ApprovedID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderCertificates", x => new { x.OrderID, x.CertificateID });
                    table.ForeignKey(
                        name: "FK_OrderCertificates_Certificates_CertificateID",
                        column: x => x.CertificateID,
                        principalTable: "Certificates",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderCertificates_Orders_OrderID",
                        column: x => x.OrderID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderCertificates_CertificateID",
                table: "OrderCertificates",
                column: "CertificateID");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_AcceptedID",
                table: "Orders",
                column: "AcceptedID");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_ApprovedID",
                table: "Orders",
                column: "ApprovedID");
